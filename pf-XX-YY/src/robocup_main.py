...
def start():
    ...
    # Video params
    resize = 1
    input_file = '../input/robocup.mp4'
    output_file = '../output/output_robocup.avi'
    ...
    while i < length - 1 or webcam:
        ...
        frame = cv2.rectangle(frame, (0, height), (width - 950, 450), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (0, 0), (400, 150), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (0, 200), (200, 50), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (0, 100), (400, 50), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (0, 0), (650, 100), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (0, 0), (700, 60), (127.5, 127.5, 127.5), -1)

        frame = cv2.rectangle(frame, (width, height), (width - 150, height - 150), (127.5, 127.5, 127.5), -1)
